...
[Lexer](#Lexer)|[wikipedia](https://en.wikipedia.org/wiki/Lexical_analysis)|need to clean quotes (with hashmap) and check for every ft_calloc() and check for command logic after lexing|
